...
public class Host extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
  ...
  public void put(int field$, java.lang.Object value) {
    switch (field$) {
    case 0: metadata = (java.util.Map<java.lang.String,java.nio.ByteBuffer>)((value instanceof org.apache.gora.persistency.Dirtyable) ? value : new org.apache.gora.persistency.impl.DirtyMapWrapper((java.util.Map)value)); break;
    case 1: outlinks = (java.util.Map<java.lang.String,java.lang.String>)((value instanceof org.apache.gora.persistency.Dirtyable) ? value : new org.apache.gora.persistency.impl.DirtyMapWrapper((java.util.Map)value)); break;
    case 2: inlinks = (java.util.Map<java.lang.String,java.lang.String>)((value instanceof org.apache.gora.persistency.Dirtyable) ? value : new org.apache.gora.persistency.impl.DirtyMapWrapper((java.util.Map)value)); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Host>
    ...
    private Builder(org.apache.nutch.storage.Host other) {
      ...
      if (isValidValue(fields()[0], other.metadata)) {
        this.metadata = (java.util.Map<java.lang.String,java.nio.ByteBuffer>) data().deepCopy(fields()[0].schema(), other.metadata);
        fieldSetFlags()[0] = true;
      }
      if (isValidValue(fields()[1], other.outlinks)) {
        this.outlinks = (java.util.Map<java.lang.String,java.lang.String>) data().deepCopy(fields()[1].schema(), other.outlinks);
        fieldSetFlags()[1] = true;
      }
      if (isValidValue(fields()[2], other.inlinks)) {
        this.inlinks = (java.util.Map<java.lang.String,java.lang.String>) data().deepCopy(fields()[2].schema(), other.inlinks);
    ...
    public Host build() {
      try {
        ...
        record.metadata = fieldSetFlags()[0] ? this.metadata : (java.util.Map<java.lang.String,java.nio.ByteBuffer>) new org.apache.gora.persistency.impl.DirtyMapWrapper((java.util.Map)defaultValue(fields()[0]));
        record.outlinks = fieldSetFlags()[1] ? this.outlinks : (java.util.Map<java.lang.String,java.lang.String>) new org.apache.gora.persistency.impl.DirtyMapWrapper((java.util.Map)defaultValue(fields()[1]));
        record.inlinks = fieldSetFlags()[2] ? this.inlinks : (java.util.Map<java.lang.String,java.lang.String>) new org.apache.gora.persistency.impl.DirtyMapWrapper((java.util.Map)defaultValue(fields()[2]));
        return record;
      } catch (Exception e) {
